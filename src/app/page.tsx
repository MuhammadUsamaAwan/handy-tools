...
export default function Home() {
  return (
    <section id='hero' aria-labelledby='hero-heading' className='container my-auto mt-40 space-y-4 text-center'>
      <h1 className='mx-auto max-w-[64rem] text-3xl font-bold leading-[0.9] sm:text-5xl lg:text-6xl'>
